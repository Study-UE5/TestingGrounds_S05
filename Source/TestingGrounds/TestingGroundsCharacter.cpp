...
void ATestingGroundsCharacter::SetupPlayerInputComponent(class UInputComponent* PlayerInputComponent)
{
	...
	// Bind fire event
	PlayerInputComponent->BindAction("PrimaryAction", IE_Pressed, this, &ATestingGroundsCharacter::OnPrimaryAction);

	// Enable touchscreen input
	EnableTouchscreenMovement(PlayerInputComponent);

	// Bind movement events
	PlayerInputComponent->BindAxis("Move Forward / Backward", this, &ATestingGroundsCharacter::MoveForward);
	PlayerInputComponent->BindAxis("Move Right / Left", this, &ATestingGroundsCharacter::MoveRight);
	...
	PlayerInputComponent->BindAxis("Turn Right / Left Gamepad", this, &ATestingGroundsCharacter::TurnAtRate);
	PlayerInputComponent->BindAxis("Look Up / Down Gamepad", this, &ATestingGroundsCharacter::LookUpAtRate);
}

void ATestingGroundsCharacter::OnPrimaryAction()
{
